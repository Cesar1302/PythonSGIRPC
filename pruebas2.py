...
class DescargaPEMBU:
    ...
    def proceso(self):
       ...
       #Se genera el archivo csv
        ...
        # # texto3=texto2.replace("Pt.,Speed","puntoRocio,velocidadViento")
        # # texto4=texto3.replace("Run,Speed","Run,velocidadRacha")
        # # texto5=texto4.replace("Dir,Chill","direccionRacha,Chill")
        # # texto6=texto5.replace("Bar","presionBar")
        # # texto7=texto6.replace("Dir,Run","direccionViento,Run")
        # # texto8=texto7.replace("Rain","lluvia")
        # # estacionunam1=open(dircsv,"w")
        ...
        # DF=pd.read_csv(dircsv, index_col=FALSE)
        ...
        # estacionunam=pd.read_csv(dircsv, usecols=(1,2,3,6,7,8,10,11,17,18,23), index_col=0, header=0)
        # print(estacionunam)
        # estacionunam.to_csv(dircsv)
...
//tranparentar imagen con python?
